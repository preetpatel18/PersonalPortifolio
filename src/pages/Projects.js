					...
					<div class="timeline">
						<div class="timeline-item visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									An application that generates personalized four-year course
									plans based on a student's major and academic requirements.
								</p>
						...
						<div class="timeline-item completed visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									Using React and Node JS, we created a fully functional Sketch
									to React Application. In this project, you can sketch on our
									Website and in return you achieve zip file of your react Application.
								</p>
								<a
						...
						<div class="timeline-item completed visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									Using R and Python, we created detailed graphical analysis of
									traffic accidents happening due to Time, location, Weather,
									and much more.
								</p>
								<a
						...
						<div class="timeline-item completed visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									Beacon is an AI-powered wildfire detection and monitoring
									system that integrates NASA's FIRMS for real-time fire data
						...
						<div class="timeline-item completed visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									Designed to aid medical schools in enhancing the student
									experience through innovative tools and resources
								</p>
								<span class="timeline-status">
									<a
						...
						<div class="timeline-item completed visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									This repository contains implementations of fundamental data
									structures and algorithms, designed to help with learning,
									practicing, and improving problem-solving skills using java in
						...
						<div class="timeline-item completed visible">
							...
							<div class="timeline-card">
								...
								<p class="timeline-description">
									In my 10th-grade APCSA final project, I built an AI-powered
									Battleship game in Java, where the computer strategically
									attacks based on probability rather than randomness, teaching
									me advanced class management and earning one of the highest
									scores in my section.
								</p>
								<span class="timeline-status">
									<a
